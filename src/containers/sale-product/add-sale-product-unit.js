...
function AddSaleUnit(props) {
  ...
  const url = `${url}sale/product/unit/create`
  function submit(e) {
    console.log(data)
    e.preventDefault();
    axios
                    ...
                    <form onSubmit={(e) => submit(e)} method="HTTP_METHOD" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="form-group col-6">
                          ...
                          <input onChange={(e) => handle(e)} id="unit_title" type="text" class="form-control" name="unit_title" placeholder="e.g AAA,29thetc" />
                        </div>
                        <div class="form-group col-6">
                          <label for="">Description</label>
                          <input onChange={(e) => handle(e)} id="unit_description" type="text" class="form-control" name="unit_description" placeholder="e.g any details about categroy" />
                        </div>
                      </div>
                      <div class="row">
