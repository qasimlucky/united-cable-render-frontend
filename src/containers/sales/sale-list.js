                    ...
                    <div className="card">
                        ...
                        <div className="table-responsive">
                            ...
                            <tbody>
                                ...
                                {currentItems && currentItems.map(orderDetails => ( 
                                <tr className="align-center">

                                <td>{orderDetails.order_collection_index}</td>
                                <td>{orderDetails.total_amount}</td>
                                <td>{orderDetails.no_of_items}</td>
                                <td>{orderDetails.customer_name}</td>
                                <td>{orderDetails.customer_phone}</td>
                                <td>{orderDetails.date} | {orderDetails.time}</td>
                                <td>
