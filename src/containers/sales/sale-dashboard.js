    ...
    useEffect(() => {
        axios.get(`${url}saleman/dashboard`).then(Response =>{
          console.log(Response.data[0])
            ...
            setTransactionData(Response.data[0].transaction_Arr)
                                        ...
                                        <div class="align-items-center justify-content-between">
                                            ...
                                            <div class="col-6">
                                                <div class="card-content">
                                                    <h5 class="font-18">Customers</h5>
                                                    <div class="font-11" >Due Payments</div>
                                                    <div class="font-11" style={{color:"red", marginBottom:"8px"}} > Rs : {data.due_payments}</div>
                                                    <div class="font-11">Total Customer : {data.total_customer} </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="align-items-center justify-content-between">
                                            <div class="row ">
                                                <div class="col-6">
                                                    <div class="card-content">
                                                        <h5 class="font-18">Today Cash</h5>
                                                        <div class="font-11" >Cash In</div>
                                                        <div class="font-11" style={{color:"red", marginBottom:"8px"}} > Rs : {data.today_cash_in} </div>
                                                        <div class="font-11">No of Customers : {data.transaction_customer}  </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="align-items-center justify-content-between">
                                            <div class="row ">
                                                    <div class="col-6">
                                                        <div class="card-content">
                                                            <h5 class="font-18">Products</h5>
                                                            <div class="font-11" >Total Products</div>
                                                            <div class="font-11" style={{color:"red", marginBottom:"8px"}} > {data.total_no_of_products}</div>
                                                        </div>
                                                    </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                <div class="banner-img">
                                            ...
                                            <div class="row ">
                                                <div class="col-6">
                                                    <div class="card-content">
                                                        ...
                                                        <div class="font-11" >Total Amount</div>
                                                        <div class="font-11" style={{color:"red", marginBottom:"8px"}} > Rs : {data.today_sale}</div>
                                                        <div class="font-11">Total orders No : {data.total_orders_number}</div>
                                                    </div>
                                                </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                <div class="banner-img">
                                            ...
                                            <div className="card-body p-0">
                                                <div className="table-responsive">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <th>Sr</th>
                                                        <th>Type</th>
                                                        <th>Transactiom Amount</th>
                                                        <th>opening Balance</th>
                                                        <th>Closing Balance</th>
                                                        </tr> 
                                                        {transactiondata && transactiondata.map(purchaseDetails => ( 
                                                        <tr className="align-center">

                                                        <td>{purchaseDetails.transaction_collection_index}</td>
                                                        <td>{purchaseDetails.transaction_type}</td>
                                                        <td>{purchaseDetails.transaction_amount}</td>
                                                        <td>{purchaseDetails.opening_balance}</td>
                                                        <td>{purchaseDetails.closing_balance}</td>
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="table-responsive">
                                                ...
                                                <tbody>
                                                    ...
                                                    {orderdata && orderdata.map(dealerDetails => ( 
                                                    <tr className="align-center">

                                                    <td>{dealerDetails.transaction_collection_index}</td>
                                                    <td>{dealerDetails.transaction_type}</td>
...
export default SaleManDashboard;