...
function AddVendorTransactionAmount(props) {
  ...
  async function transactionImage (e){
    ...
    const Accountbalance = VendorData.account_balance
   // setCustomerId(customer_id)
   // setOpeningBalance(Accountbalance)
    

  const url = `${url}vendor/transaction/add-amount`
...
export default AddVendorTransactionAmount;